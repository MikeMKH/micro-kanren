...
(run-tests
 (test-suite "examples"
  ...
  (test-equal? "a-and-b" (a-and-b empty-state)
    '((((#(1) . 5) (#(0) . 7)) . 2)
      (((#(1) . 6) (#(0) . 7)) . 2)))
  ;(test-equal? "fives" ((call/fresh fives) empty-state) '((((#(0) . 5)) . endless))) ; endless loop, need take with Zzz
  (test-equal? "five" ((call/fresh five) empty-state) '((((#(0) . 5)) . 1)))
  ;(test-equal? "fives-and-sixes" (fives-and-sixes empty-state) '((((#(0) . 5)) . endless))) ; endless loop, need take with Zzz
